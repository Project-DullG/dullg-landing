...
const sections = [
  ...
  },
  {
    ...
    body: (
      <p>
        수집한 정보는 요청 처리일로부터 최대 1년간 보관한 뒤 지체 없이
        삭제합니다. 다만 관련 법령에 따라 보존이 필요한 경우에는 해당 기간만큼
        분리해 보관할 수 있습니다. 동의를 철회하면 보존 의무가 없는 정보는
        지체 없이 삭제합니다.
      </p>
    ),
  },
  ...
  },
  {
    ...
    body: (
      <p>
        개인정보 수집·이용에 동의하지 않을 수 있습니다. 다만 필수 정보 제공에
        동의하지 않으면 웹 양식을 통한 자료 발송이 어렵습니다. 열람, 정정,
        삭제, 처리 정지 또는 동의 철회를 원하면 아래 이메일로 요청할 수
        있습니다.
      </p>
    ),
  },
      ...
      <section className="privacy-content shell" aria-label="개인정보 처리 안내">
        ...
        <div className="privacy-sections">
          ...
          <article>
            ...
            <p>
              개인정보 관련 요청은{" "}
              <a href={emailHref}>{BRAND.email}</a>으로 보내주세요.
