...
export const works: Work[] = [
  ...
  },
  {
    ...
    duration: "150분",
    platform: "UZU",
    synopsis: "잿빛 머리 소녀가 만든 네 인형과 한 통의 초대장에서 시작되는 판타지 미스터리입니다. 세계관에 숨은 규칙과 작은 단서를 세밀하게 연결해야 진실에 닿을 수 있습니다.",
    ...
    characteristics: ["판타지 세계의 규칙이 추리 근거로 작동", "네 인형의 정보가 서로 연결되는 구성", "긴 호흡의 텍스트 중심 작품"],
