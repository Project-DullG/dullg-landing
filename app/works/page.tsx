  ...
  return (
    <PageFrame>
      <section className="works-hero shell">
        ...
        />
        <p>
          공개된 작품의 줄거리와 플레이 정보를 한 편씩 소개합니다. 작품을 선택하면 상세 정보와 공식
          기록을 확인할 수 있습니다.
        </p>
      </section>
          ...
          <div className="shell">
            <div className="live-funding-head">
              ...
              <div>
                ...
                <p>{currentFunding.checkedAt} 확인 · 펀딩 중 수치는 변동될 수 있습니다.</p>
      ...
      <section className="work-ledger shell" aria-labelledby="work-list-title">
        <SectionHead
          className="work-ledger-head"
          id="work-list-title"
          kicker="포트폴리오"
          title="작품마다 다른 세계와 사건"
          lead="이미지를 선택하면 작품별 상세 페이지로 이동합니다."
        />
        <div className="portfolio-list">
          {publishedWorks().map((work, index) => (
            <article key={work.slug}>
              ...
              <div>
                <span>
                  {String(index + 1).padStart(2, "0")} · {getWorkStatus(work)}
                </span>
                <h3>{work.title}</h3>
                <b>
