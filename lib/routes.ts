...
export const publicRoutes: PublicRoute[] = [
  ...
  {
    path: "/activity/ulleung-ecotourism-ai",
    title: "울릉군 생태관광 AI 교육",
    description: "2026년 7월 4일 교육 내용과 개인정보 보호 처리된 현장 사진을 확인합니다.",
    group: "studio",
    priority: 0.6,
    changeFrequency: "monthly",
  },
  ...
  {
    path: "/materials/ulleung-ecotourism-ai",
    title: "울릉군 생태관광 AI 교육 자료",
    description: "2026년 7월 4일 교육 자료와 개인정보 보호 처리된 현장 사진을 확인합니다.",
    group: "resources",
    priority: 0.6,
    changeFrequency: "monthly",
  },
