...
export default function Home() {
  return <main className="academy-landing"><Header />
    ...
    <section className="landing-faq shell"><div className="landing-section-head"><Kicker>FREQUENTLY ASKED</Kicker><h2>검토 전에<br /><em>궁금한 점을 확인하세요.</em></h2></div><div className="faq-list">{faqs.map(([question, answer], index) => <details key={question} open={index === 0}><summary>{question}<span>＋</span></summary><p>{answer}</p></details>)}</div></section>
