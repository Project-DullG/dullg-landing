...
2026-09-02 기준. 사이트에는 단서공방(ProjectDullG)이 직접 개설한 공식 프로젝트의 공개 대표 이미지만 사용한다.
...
UZU의 《잿빛 소녀가 죽은 추억(醜憶)》 대표 이미지는 공식 공개 페이지에서 확인했지만, 현재 파일이 프리퀄 콘텐츠 문구를 포함해 사이트에는 사용하지 않는다.
