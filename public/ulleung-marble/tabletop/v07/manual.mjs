...
export function manualPages(d){return [
 ...
 page(2,MANUAL_TITLES[1],'카드를 나누고, 타고 올 배를 고릅니다.',`
  ...
  ${section('02','한 사람씩 준비하기',`<p>서로 다른 여행자북과 미플을 고르고 목표 두 가지를 공개합니다. 미플과 같은 색 예산 큐브를 모두 <b>50</b>에 놓습니다.</p><p>여행자북 <b>6쪽</b>의 코스 번호를 확인하고, 같은 번호의 <b>코스 카드 1장</b>을 찾아 공개합니다. 각 인물에게 정해진 세 장소가 방문 목표입니다. 남은 코스는 상자에 넣습니다.</p>`)}
