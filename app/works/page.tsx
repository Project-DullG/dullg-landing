  ...
  return <PageFrame>
    ...
    <section className="live-funding" aria-labelledby="live-funding-title"><div className="shell">
      <div className="live-funding-head">
        ...
        <div><b>9월 11일까지</b><p>2026년 9월 2일 확인 · 펀딩 중 수치는 변동될 수 있습니다.</p><a href="https://tumblbug.com/projectdg2" target="_blank" rel="noreferrer">텀블벅 프로젝트 보기 <ArrowUpRight size={16} weight="bold" aria-hidden="true" /></a></div>
      </div>
      <div className="live-work-list">
        {currentWorks.map(work => <article key={work.slug}>
          <Link href={`/works/${work.slug}`} aria-label={`${work.title} 상세 보기`}><img src={work.image} width="1000" height="1000" alt={work.alt} /></Link>
      ...
      <div className="live-funding-stats"><span><small>확인한 모인 금액</small><strong>10,940,000원</strong></span><span><small>후원자</small><strong>169명</strong></span><span><small>달성률</small><strong>1,094%</strong></span><p>2026년 9월 2일 텀블벅 공개 페이지 확인 기준입니다.</p></div>
    </div></section>
    ...
    <section className="work-ledger shell" aria-labelledby="work-list-title">
      ...
      <div className="portfolio-list">{publishedWorks.map((work,index)=><article key={work.slug}>
        <figure><Link href={`/works/${work.slug}`} aria-label={`${work.title} 상세 보기`}><img src={work.image} width="1000" height="1000" alt={work.alt} loading="lazy" /></Link></figure>
    ...
    <section className="funding-archive shell" aria-labelledby="funding-archive-title">
      ...
      <div className="funding-archive-list">
        <a href="https://tumblbug.com/projectdg0" target="_blank" rel="noreferrer"><span>2025.09.09—10.11</span><strong>뱀이 죽은 축제</strong><b>9,001,000원 · 250명 · 180%</b><i>보기 ↗</i></a>
        <a href="https://tumblbug.com/projectdg1" target="_blank" rel="noreferrer"><span>2026.03.16—04.20</span><strong>머더미스터리 3종</strong><b>19,296,000원 · 193명 · 1,929%</b><i>보기 ↗</i></a>
